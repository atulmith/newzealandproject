...
export const EXAMPLES_FIRSTHIT_BEGIN = 'EXAMPLES_FIRSTHIT_BEGIN';
export const EXAMPLES_FIRSTHIT_SUCCESS = 'EXAMPLES_FIRSTHIT_SUCCESS';
export const EXAMPLES_FIRSTHIT_FAILURE = 'EXAMPLES_FIRSTHIT_FAILURE';
export const EXAMPLES_FIRSTHIT_DISMISS_ERROR = 'EXAMPLES_FIRSTHIT_DISMISS_ERROR';
